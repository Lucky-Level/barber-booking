// Barber Booking - Loyalty card, confetti, realtime & frequency
...
function renderLoyaltyCard(client) {
  ...
  container.innerHTML = `
    <div class="loyalty-card" style="margin-top: 16px;">
      ...
      <div class="lc-header">
        <div class="lc-brand">
          <div class="lc-title">Barber Booking</div>
...
function launchConfetti() {
  ...
  const colors = ['#c8a97e', '#e8d5b5', '#ffd700', '#e05555', '#4caf50', '#5555e0', '#ffffff'];
  const particles = [];
